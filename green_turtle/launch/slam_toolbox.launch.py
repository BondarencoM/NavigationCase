...
def generate_launch_description():
    ...
    mapping_config_file = os.path.join(get_package_share_directory('green_turtle'), 'config', 'slam', 'mapping.yaml')
    ...
    # Start rviz
    rviz_config_dir = os.path.join(get_package_share_directory('green_turtle'),
